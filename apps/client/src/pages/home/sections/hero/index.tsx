      ...
      >
        <div className="mt-10 space-y-2">
          <h1 className="text-4xl font-bold tracking-tight sm:text-6xl">
            {t`Streamline your job search with a resume that works.`}
          </h1>
        </div>
          ...
          >
            <Tilt {...defaultTiltProps}>
              <img
                ...
                alt="InternzValley Resume Builder - Screenshot - Builder Screen"
                className="w-[76rem] rounded-xl bg-secondary/5 shadow-2xl ring-1 ring-secondary/10"
              />
            </Tilt>
          </motion.div>
        </div>
